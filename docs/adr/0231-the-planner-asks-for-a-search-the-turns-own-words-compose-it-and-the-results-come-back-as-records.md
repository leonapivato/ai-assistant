...
- **Note (2026-09-13): the `Status` line's scope text now names clauses without `ADR-NNNN`
  ...
  parentheses. A consumer doing what §4 says a consumer does read ADR-0148, ADR-0193 and
  ADR-0226 as supersession targets of this ADR, which they are not.
  **The targets are unchanged — ADR-0235, ADR-0238, ADR-0241, ADR-0242 and ADR-0244 — each
  ...
  places no constraint in a note:** the in-turn-servicing clause is **ADR-0226 §5's**, the
  route enumeration is **ADR-0148 §3's**, the clause binding entire so that no grant
  covers a request planned over external content is **ADR-0193 §4's**, and what the
  composing stage is told is **ADR-0242 §6's**. Of those, only ADR-0242 is a target of
  this line; ADR-0226, ADR-0148 and ADR-0193 supersede no part of this ADR.
