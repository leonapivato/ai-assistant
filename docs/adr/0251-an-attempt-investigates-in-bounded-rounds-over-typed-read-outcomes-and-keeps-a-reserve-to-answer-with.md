...
- Partially superseded: 2026-09-13 by ADR-0258 — **§3's name for the model it mints, and
  ...
  **The name is replaced wherever this ADR writes it for that model, not in §3 alone**, because
  ...
  once would be worse than the divergence this closes. The seven: §3's minting clause and its
  parameter clause and their heading; **§12's writer clause**, *"each round's `ReadOutcomeKind`
