...
- **Partially superseded: 2026-09-15 by ADR-0266 — §1 in four limbs, §2's member shape and two
  ...
  and §10's resolution enumeration in its closure at three, §11's `CoverageView` field list, and
  §16's roster in three limbs. Eleven scopes, and nothing else in this ADR.** No clause of this
  ...
  **Every other clause of the eleven sections binds entire.** §1's three write paths themselves,
  ...
  moved. §7, §12, §14 and §§17-22 are not reached at all.
