...
- **Partially superseded: 2026-09-15 by ADR-0266 — §1's proposal-completeness condition, §2's
  ...
  in the narrowing direction, §9 clause (ii)'s test of *"bear on"*, and §8's and §10's resolution
  enumeration in its closure at three. Nothing else in this ADR.** No
  ...
  **Every other clause of the eight sections binds entire.** §1 is untouched but for its third
