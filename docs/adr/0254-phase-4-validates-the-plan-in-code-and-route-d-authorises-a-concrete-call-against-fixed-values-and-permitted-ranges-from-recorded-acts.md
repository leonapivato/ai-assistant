...
- **Partially superseded: 2026-09-15 by ADR-0266 — §1 in four limbs, §2's member shape and two
  ...
  **§20's arms 8, 10, 14, 15, 20, 47, 53 and 54** are each stated over the contract that
  decision changes — arm 10 reads the `currency_argument` no bound carries, arms 8, 47, 53 and 54
  turn on a record *"naming that argument in no member"* and on condition 6 over key sets, arms
  15 and 20 carry the limbs superseded with §5 and §9 above, and arm 14's record fixes an entity
  **and** terms in one row, which one member per kind refuses. **Each is restated over the new
  shape by that decision's first lane and none is dropped.** **Arm 5 stands verbatim**,
  `maximum_exclusive` defaulting to `False`, and arm 14's `TERMS` and `PERIOD` members stay
  constructible: §2 admits them and the new reading mints none, which are two different things.
  ...
  **Every other clause of the twelve sections binds entire.** §1's three write paths themselves,
  ...
  moved, and §20's lane cut, ordering and every other arm bind entire. §7, §12, §14, §§17-19,
