...
- **Note (2026-09-13): the `Status` line's scope text now names clauses without `ADR-NNNN`
  ...
  **The targets are unchanged — ADR-0247, ADR-0248 and ADR-0249 — each still paired with
  ...
  in a note:** the record ADR-0249's scope layers on, and the one that widened §2's
  three-content-fields clause to four, are both **ADR-0248's** — a target of this line by
  a pair of its own, directly above.
