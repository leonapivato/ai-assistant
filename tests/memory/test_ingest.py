...
async def test_superseding_a_target_never_extends_its_existing_window() -> None:
    ...
    # A target that already self-closes earlier than the writer's clock keeps that
    ...
    # store reads before the earlier end so the target is a live conflict.
    ...
    # Kept at the earlier self-close, not extended to the writer's 2026-06-01 clock.
